...
export default {
  ...
  methods: {
    ...
    addFinance() {
      if (this.accountAssociatesCode === undefined || this.accountAssociatesCode.length == 0) {
      ...
      console.log(data)
      this.$store.dispatch('logi/base/INSERT_FINANCE', data).then(() => {
