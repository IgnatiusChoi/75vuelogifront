...
import single from "echarts/src/coord/single/Single";
...
export default {
  ...
  computed: {
    ...mapState({
      workplaceList: state => state.logi.compInfo.workplaceList,
      tableColumns: state => state.logi.compInfo.tableColumns,
    }),
  },


  created() {
    this.$store.dispatch('logi/compInfo/setTable', tableColumnsData)
